	...
	<div class="orders">
	   <div class="row">
		  <div class="col-xl-12">
			 <div class="card">
				<div class="card-body">
				   <h4 class="box-title">PEREKAPAN STOK</h4>
				   <h4 ><a href="detail_stok.php">Tambah Barang</a> </h4>
				</div>
				<div class="card-body--">
						 ...
						 <tbody>
							...
							<tr>
							   ...
							   <td>
								...
								echo "<span class='badge badge-edit'><a href='detail_stok.php?id=".$row['id']."'>Edit</a></span>&nbsp;";
